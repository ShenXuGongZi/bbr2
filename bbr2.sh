...
install_kernel() {
    if [[ "$environment_headers" != "true" ]]; then
        [ ! -f "linux-headers-5.2.0-rc3+_5.2.0-rc3+-1_amd64.deb" ] && wget --no-check-certificate -O linux-headers-5.2.0-rc3+_5.2.0-rc3+-1_amd64.deb "http://dl.miaosu.bid/linux-headers-5.2.0-rc3%2B_5.2.0-rc3%2B-1_amd64.deb"
    ...
    if [[ "$environment_image" != "true" ]]; then
        [ ! -f "linux-image-5.2.0-rc3+_5.2.0-rc3+-1_amd64.deb" ] && wget --no-check-certificate -O linux-image-5.2.0-rc3+_5.2.0-rc3+-1_amd64.deb "http://dl.miaosu.bid/linux-image-5.2.0-rc3%2B_5.2.0-rc3%2B-1_amd64.deb"
